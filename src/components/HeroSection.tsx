      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10 pt-10 md:pt-20">
          <div className="flex flex-col space-y-6 md:space-y-8 md:w-1/2 z-10">
            ...
            <h1 className="text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold leading-tight tracking-tighter animate-fade-in" style={{
            animationDelay: '0.4s'
          }}>
              Your Essentials,
              <br />
            ...
            <p className="text-base md:text-lg text-gray-600 max-w-lg animate-fade-in" style={{
            animationDelay: '0.6s'
          }}>
          ...
          <div className="relative md:w-1/2 h-full flex items-center justify-center z-0 mt-10 md:mt-0">
            ...
            <div className="relative w-full max-w-md aspect-square hidden md:block">
              <div className={cn("absolute w-full h-full rounded-full bg-gradient-to-br from-accent/20 to-primary/20", "animate-pulse opacity-70")}></div>
              
              <div className="absolute top-[-5%] left-[-10%] w-60 h-60 animate-float" style={{
              animationDelay: '0s'
            }}>
                <div className="glass-card rounded-2xl p-4 transform rotate-[-5deg] shadow-lg">
                  <img src="https://images.unsplash.com/photo-1610832958506-aa56368176cf?q=80&w=300&auto=format&fit=crop" alt="Fresh vegetables" className="w-full h-full object-cover rounded-lg" />
                </div>
              </div>
              
              <div className="absolute top-[25%] right-[-15%] w-48 h-48 animate-float" style={{
              animationDelay: '1.5s'
            }}>
                <div className="glass-card rounded-2xl p-4 transform rotate-[7deg] shadow-lg">
                  <img src="https://images.unsplash.com/photo-1609780447631-05b93e5a88ea?q=80&w=240&auto=format&fit=crop" alt="Fresh fruits" className="w-full h-full object-cover rounded-lg" />
                </div>
              </div>
              
              <div className="absolute bottom-[-10%] left-[15%] w-40 h-40 animate-float" style={{
              animationDelay: '0.7s'
            }}>
                <div className="glass-card p-3 shadow-lg py-[16px] mx-0 my-0 rounded-2xl px-[12px]">
                  <img src="https://images.unsplash.com/photo-1618160702438-9b02ab6515c9?q=80&w=240&auto=format&fit=crop" alt="Fresh bread" className="w-full h-full object-cover rounded-lg" />
                </div>
              </div>
            </div>
            ...
            <div className="md:hidden w-full max-w-xs">
              <div className="glass-card rounded-2xl p-4 shadow-lg">
                <img src="https://images.unsplash.com/photo-1610832958506-aa56368176cf?q=80&w=300&auto=format&fit=crop" alt="Fresh produce" className="w-full h-full object-cover rounded-lg" />
              </div>
            </div>
          </div>
        </div>
